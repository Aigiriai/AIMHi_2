    ...
    try {
      ...
      for (const jobDoc of jobDescriptions) {
        try {
          ...
          // PERMANENTLY DISABLED: Template generation causes SQLite database corruption
          ...
          */
          console.log(`✅ Job created successfully (template generation permanently disabled): ${job.title}`);
